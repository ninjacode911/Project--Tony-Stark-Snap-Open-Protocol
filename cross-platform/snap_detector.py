...
macOS note: the system will prompt for microphone permission on first run.
"""
...
class SnapDetector:
    ...
    def start(self) -> None:
        ...
        try:
            ...
            if "unanticipated host error" in error_msg or "permission" in error_msg:
                print("\n  [ERROR] Microphone access denied.")
                print("  On macOS: System Settings > Privacy & Security > Microphone")
                print("           Grant access to Terminal / your IDE.")
                print("  On Linux: Ensure PulseAudio or PipeWire is running.")
            else:
